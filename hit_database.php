...
<div id="sidebar" onclick="togglemenu()">
		...
		<ul>
			...
			<li><a href="#" style="text-decoration:none;"><i class="fas fa-file"></i>View of Final Routine</a>
				<ul><li><a href="finalroutine.php">Final Routine</a></li></ul>	
				...
				<ul><li><a href="dayroutine.php">Show The Day Routine</a></li></ul>
			</li>
    ...
    <div class="container">
			<div class="jumbotron">
				<h1><strong>Hit Requirment</strong></h1>
				<p>Just <strong>Hit or Press </strong> the button</p>
            </div>
            <a href="requirment.php"><button class="btn btn-primary">Set or Hit the requirment</button></a><br><br><br><br>
    
    <h4 style="float:left"><strong>After that click here --></strong></h4>
    <a href="create_final_routine.php"><button class="btn btn-success" style="float: right;">Create Routine</button></a>
    </div>    
</center>
