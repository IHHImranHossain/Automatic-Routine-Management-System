...
<div id="sidebar" onclick="togglemenu()">
	...
	<center>
		...
		<div class="container">
			<div class="jumbotron">
				<h1><strong>View Lab Rooms</strong></h1>
				<p>There is have <strong>Room Number</strong>,<strong>Academic Building</strong>,<strong>Floor Number & Room Capacity.</strong></p>
			</div>
							...
							<table class="table table-bordered table-striped">
								<thead>
									<tr>
										...
										<th scope="col">Academic Building</th>
								...
								<tbody>
									<tr>
										<?php
											...
											$query = "SELECT * FROM lab_room order by Room_Number ASC";
										...
										?>
												...
												<td><?php echo $row['Academic_Building'] ?></td>
