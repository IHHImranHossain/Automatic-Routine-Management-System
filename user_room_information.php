    ...
    <center>
        <div class="container">
            <form action="" method="POST">
                ...
                <div id="ab"><big style="font-size: large;"><strong>Select Room Number: </strong> </big>  &nbsp;
                        <select name="Room_Number" id="Room_Number" style="border-radius: 4px; font-size:medium" required >  
                            <option value="" selected disabled="">--Select Room Number--</option>
                                <?php
                                    include_once("config.php");
                                    $querys = "SELECT Room_Number FROM room_table";
                                    ...
                                    if ($results) 
                                    {
                                        while($row=mysqli_fetch_array($results))
                                        {
                                            ...
                                            echo"<option>$Room_Number<br></option>";
                                        }
                                    }	
                                ?>
                        </select><br> <br>
                    ...
                    <form method="post"  action="">
                        <div id="table-container">
                                <table class="table table-bordered table-striped" id="tbl">
                                    <thead class="tbl">
                                        <tr>
                                            <th scope="col"><h4><strong>Room_Number</strong> </h4></th>
                                            <th scope="col"><h4><strong>Room_Type</strong> </h4></th>
                                            <th scope="col"><h4><strong>Academic_Building</strong> </h4></th>
                                            <th scope="col"><h4><strong>Floor_Number</strong> </h4></th>
                                        </tr>
                                    </thead>
                                    <tbody class="tbl">
                                        <tr>
                                            <?php
                                                if(isset ($_POST['submit']))
                                                {
                                                    ...
                                                    $sql="select * from room_table where Room_Number like '$Room_Number'";
                                                    $result= mysqli_query($mysqli,$sql);
                                                            
                                                    while($row=mysqli_fetch_assoc($result))
                                                    {
                                            ?>
                                                        <td><h5><?php echo $row['Room_Number'] ?></h5></td>
                                                        <td><h5><?php echo $row['Room_Type'] ?></h5></td>
                                                        <td><h5><?php echo $row['Academic_Building'] ?></h5></td>
                                                        <td><h5><?php echo $row['Floor_Number'] ?></h5></td>
