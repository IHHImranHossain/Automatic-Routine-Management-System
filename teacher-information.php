...
<?php
	...
	check_login_user();
	$query = "SELECT * FROM teachers_information order by id DESC";
...
<html>
	...
	<div id="sidebar" onclick="togglemenu()">
		...
		<center>
			...
			<div class="container">
				<div class="jumbotron">
					<h1><strong>Teachers Information</strong></h1>
					<p>There is have <strong>Teacher_Name</strong>,<strong>Teacher_Initial_Name</strong>,<strong>Email</strong>,<strong>Phone_Number & Max_Cr</strong><br>You have to <strong>Edit</strong>,<strong>Delete & Add New</strong> Teachers Data in those rows.</p>
				</div>
				<?php 
					if (isset($_POST['search'])) 
					{
						$search = $_POST['search'];
						$sql = "SELECT * FROM teachers_information where Teacher_Initial_Name like '%$search%'";
				...
				<form action="" method="POST">
					...
					<input type="text" name="search" id="search" class="srs" placeholder="Search By Initial Name" value="<?php echo $search?>">
					...
					<button class="btn btn-primary" style="margin-left:600px;"><a style="color:white; text-decoration:none;" href="teacher-add.php">Add Teacher</a></button>
				</form><br>
				...
				<table class="table table-bordered table-striped">
					<thead>
						<tr>
							<th style="font-size:18px;">Teacher_Name</th>
							<th style="font-size:18px;">Initial_Name</th>
					...
					<tbody>
						...
						<?php
							echo "<td><a href=\"teacher-edit.php?id=$row[id]\"><button class='btn btnn btn-sm'>Edit</button></a> | <a href=\"teacher-delete.php?id=$row[id]\" onClick=\"return confirm('Are you sure you want to delete?')\"><button class='btn btnn btn-sm'>Delete</button></a></td>";
						}
						?>
