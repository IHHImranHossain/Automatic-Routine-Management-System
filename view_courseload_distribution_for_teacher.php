...
<head>
	...
	<title>View Course Load Distribution For Teacher Of Semester</title>
...
<div id="sidebar" onclick="togglemenu()">
	...
	<center>
		...
		<div class="container">
			<div class="jumbotron">
				<h1><strong>View Course Load Distribution For Teacher Of Semester</strong></h1>
				<p>There is have <strong>Level Termr</strong>,<strong>Course Code</strong>,<strong>Section & All Course Information.</strong></p>
			</div>
									...
									<tr>
										<?php
											if(isset ($_POST['submit']))
											{
												...
												$sql="select * from $Semester order by Level_Term";
